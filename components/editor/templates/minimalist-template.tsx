...
export function MinimalistTemplate({ profile, links, socials, font }: TemplateProps) {
        ...
        <AnimatePresence mode="popLayout">
          {activeLinks.map((link) => {
            ...
            <motion.a
              ...
              className="block w-full text-center text-sm font-medium transition-all duration-200 overflow-hidden group relative flex items-center justify-center bg-zinc-900 border border-zinc-800 rounded-xl hover:scale-[1.02] active:scale-[0.98] p-3.5"
            >
              {link.image ? (
                <div className="flex items-center w-full h-full">
                  <div className="w-14 h-14 overflow-hidden flex-shrink-0 bg-black/20 rounded-xl">
